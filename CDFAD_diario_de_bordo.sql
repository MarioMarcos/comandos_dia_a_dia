...
=============================================================================
----------------------------------------------------------------------------
                      TUTORIAL CRIAÇÃO DE USUARIO DO LINUX 
---------------------------------------------------------------------------
VÁ PARA O SUDO OU PARA ROOT ------ MAS CUIDADO

1-use o ADDUSER OU USERADD nomeusario (pocteradata
 do esse funcionou depois do adduser  


2-defina uma senha com o passwd nomeusuario (pocteradata)
cuidado para não digitar vazio e atenção se for no root para não alterar o mesmo


3--faça isso aqui para criar no home
usermod -d /home/pocteradata -m pocteradata

--julioxxxxxxx

4--para adicionar a um grupo --obs: preste atenção se o grupo já existe no nosso 
caso vamos usar o pcenter como dono e como grupo vamos usar o poc que foi criado novo sem previlégio nenhum com 775.
esse aqui é para adicionar
    sudo addgroup financeiro
    
esse aqui é para alterar


-flavio   dicas

simular na sua maquina 


--------------------------------------------------------------------------------
-----O objetivo aqui é criar uma pasta p_33393_pocteradata para que o usuário pocteradata acesse com todos os privilegios inclusives recursivos somente a pasta p_33393_pocteradata

5-criar a pasta dentro de /home/dwpub/data/p_33393_pocteradata


6-permissão para a pasta: 775 
 chown -R pocteradata p_33393_pocteradata

7-para mudar um grupo 
  usermod -A dwtg pocteradata --ver com o gustavo


--EXPLICATIVA DO GUSTAVO APLICAÇÃO PARA USUÁRIO ABAIXO

dwpub@MAXSERPRO01-1-16:/data> ls -ltr
total 1748843316
drwx------  2 root    root          16384 Jun  9  2013 lost+found
-rw-r-x---  1 root    root     1260443021 Dec 12  2014 lancamentos20141212_2014
drwxr-x---  7 root    root          20480 May 26  2015 serpro
drwxr-x---  2 dwpub   root           8192 Jun  1  2015 pagef
drwxr-x---  2 dwpub   root          28672 Jun 25  2015 custos
drwxr-x---  2 dwpub   root           4096 Jun 25  2015 custos_utf8
drwxr-x---  4 dwpub   root          12288 Jul 11  2015 snsp
drwxr-x---  3 qware   users          4096 Aug 10  2015 qware
drwxrwxr-x 13 pcenter dwtg           4096 Dec  1  2015 d_08291_tesourotransparente_pcenter_tra
drwxr-x--- 14 pcenter users          4096 Dec  2  2015 p_08291_tesourotransparente_pcenter_tra
drwxr-x---  4 root    root           4096 Dec 17  2015 backup_17122015
drwxrwxr-x 14 pcenter dwtg           4096 Feb 26  2016 h_33393_dwstn_pcenter_tra
-rwxr-x---  1 root    root            223 Jun  1  2016 teste.sh
-rw-r-----  1 root    root  1787806104801 Jun  8  2016 20160602_bkp_online_data.tar.bz2
drwxrwxr-x 18 pcenter dwtg           4096 Jun 14  2016 d_33393_dwstn_pcenter_tra
drwxr-x---  3 root    root           4096 Sep 14  2016 backups_diversos
drwxrwxr-x 13 pcenter users          4096 Dec 22  2016 p_33393_dwstn_pcenter_tra
drwxr-x---  2 root    root           4096 Jun 29  2017 arquivos_prod
drwxr-x---  3 pcenter users          4096 Jun 29  2017 p_33393_dwstn_pcenter_tra_new
drwxr-x---  3 root    root           4096 Nov  5  2018 andre
drwxrwxr-x 28 dwpub   root           4096 May 29 15:04 dwpub
drwxrwxr-x  2 pcenter poc            4096 May 30 15:55 p_33393_pocteradata
...
dica 1: ls -l ou ls -l path para visualizar as permissões
...
dica 3: ver todos os usuários do sistema.
cat /etc/passwd

dica 4: apagar usuário
sudo userdel nomeusuario


dica 5: adionar usario ao novo grupo
sudo adduser nomeusuario nomegrupo

dica 6: apagar usuario de um grupo 
sudo deluser nomeusuario sudo --esse aqui vou fazer com o users no pcenter

deluser pocteradata users
...
--para ver em que grupos o usuário está
MAXSERPRO01-1-16:/home/dwpub/data/p_33393_pocteradata # id pocteradata
uid=782(pocteradata) gid=100(users) groups=100(users),1006(poc)
...
MAXSERPRO01-1-16:~ # history | grep chmod
  349  2018-12-27 14:40:08 chmod +x criausuario.sh 
  473  2019-02-15 19:07:55 chmod +x opsware-agent-50.0.60129.5-linux-SLES-11-X86_64 
  509  2019-02-15 19:34:24 chmod +x opsware-agent-75.0.79005.0-linux-SLES-11-X86_64 
  673  2019-05-30 10:54:47 chmod -R 777 /home/dwpub/data/p_33393_pocteradata
  692  2019-05-30 11:26:32 chmod 777 p_33393_pocteradata
>>722  2019-05-30 12:18:56 chmod -R 100 /home/dwpub
isso aqui acima não pode acontecer nunca. Atenção para fazer por grupo nas pasta que vocẽ criou, veja acima as dicas e a forma correta de fazer para um usuário existente.

  825  2019-05-30 17:03:46 chmod -R 775 p_33393_pocteradata
  831  2019-05-30 17:03:46 chmod -R 775 p_33393_pocteradata
  913  2019-05-30 15:58:54 chmod 777 -R /home/dwpub/data/p_33393_pocteradata/
  938  2019-05-31 09:07:03 history | grep chmod
  998  2019-05-31 09:09:11 chmod -R 775 /home/dwpub

----------------------------------------------------------------------------
                        FINAL CRIAÇÃO DO USUÁRIO.
---------------------------------------------------------------------------
...
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              COPIA DE ARQUIVOS DO EXADATA PARA MINHA MAQUINA
---------------------------------------------------------------------------
A) do exadata para minha máquina --CONDOMINIO COPIA DE ARQUIVOS
--alias com o túnel tu117 tem que está ativo
...
b) da minha máquina para o exadata Brasilia
scp pessoal301_bitmap.sql dwpub@161.148.236.117:/car_54147_siapedw_tra/carga/pessoal3/sql/pessoal301_bitmap.sql

scp pimba_03-CREATE-BITMAP-INDEX dwpub@161.148.236.117:/car_35104_ssddwspu_tra/carga/pimba_03-CREATE-BITMAP-INDEX



=================================================================================
--Copiar para minha máquina 
--tem que está logado com o tunelexaspo
--permissão para o usuário 76455424115
--alias com o túnel tunelexaspo tem que está ativo
exemplos
scp -P 22130 76455424115@localhost:/tmp/rev_DIME.sql .
--scp -P 22130 76455424115@localhost:/tmp/*.gz .


scp -P dwpub@161.148.236.49:/data/dwpub/scripts.gz .


----------------------------------------------------------------------------
                   FINAL COPIA DE ARQUIVO EXADATA
--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Recebimento pela COADM de Ficha de Recomendação com assinatura digital e documentação digitalizada (conteúdo programático e declaração de matrícula ou de participação no processo seletivo).
Encaminhar para a caixa corporativa do Programa posgraduacao@serpro.gov.br
...
######################################################################
************************************************************************
1-usuario fazer tutorial
2-ID_ORGAO_EMI OU EMITENTE.... FAZER OS TESTES TERADATA COM GUSTAVO
3-colocar bloco 15 após carga lançamento no controlm e no documento
  operacional --- pendente -- b15 ou b16 não pode rodar antes do carga lançamento ........ terminar
4-POC_TERADATA
5-tutorail instalcao java e outros -- fotos estão no  celular
6-


--@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@