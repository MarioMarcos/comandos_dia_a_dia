            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        palette.buttonText: Qt.lighter("#b4b400", 1.1)
                    }
                    PropertyChanges {
                        target: parent.children[index].background
                        border.color: Qt.lighter("#b4b400", 1.3)
                    }
                },
                State {
                    name: "hovered"
                    ...
                    PropertyChanges {
                        target: parent.children[index]
                        palette.buttonText: Qt.lighter("#b4b400", 1.5)
                    }
                    PropertyChanges {
                        target: parent.children[index].background
                        border.color: Qt.lighter("#b4b400", 1.7)
                    }
                },
                State {
                    name: "focused"
                    ...
                    PropertyChanges {
                        target: parent.children[index]
                        palette.buttonText: Qt.lighter("#b4b400", 1.3)
                    }
                    PropertyChanges {
                        target: parent.children[index].background
                        border.color: Qt.lighter("#b4b400", 1.5)
                    }
                }
            ]
